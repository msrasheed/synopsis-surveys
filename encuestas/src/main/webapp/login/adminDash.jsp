...
<head>
<!-- 
This is the main dash for administrators. Here, they can view, correct, and create new Courses, Student Accounts,
Instructor Accounts, Classrooms, and Companies that we work with. It is my idea that this info be stored on its
own table in the database, and the primary keys for these tables used as foreign keys for a table combining the infomation
later. It was my intention to make everything as similar as possible, so if a new course, account, classroom, or empresa
is to be added, they are all redirected to the jsp CosaNueva.jsp. There, depending on the hidden text input box "type", different 
information will be asked for and displayed. There is another hidden text input box "action" that is used later as well. 
 -->
...
.tablink {
  ...
  padding: 14px ;
  font-size: 20px;
  width: 20%; /*If you want to add more tabs, change this number. Since there are 5 tabs currently, the width is 20% or 1/5 */
}
